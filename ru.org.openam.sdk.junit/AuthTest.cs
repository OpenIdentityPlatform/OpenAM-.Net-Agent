...
namespace ru.org.openam.sdk.junit
{
    ...
    public class AuthTest
    {
        ...
        public void login_bad_Test()
        {
            try
            {
                Session actual = Auth.login("/", auth.indexType.moduleInstance, "Application", new Callback[] { new NameCallback(Config.getAppUser()), new PasswordCallback("xxxxxxxxxxxxx") });
            }
            catch (AuthException)
            { 
            }
